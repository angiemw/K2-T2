...
p_clr_ltr <- ggplot(b2_clean, aes(x = ctopp_c_raw, y = ctopp_l_raw)) + 
  ...
  labs(title = "CTOPP Color and Letter (raw scores)", 
       x = "Color Naming Raw Score (time to finish in seconds)",
       y = "Letter Naming Raw Score (time to finish in seconds)",
       caption = "Lower raw score = better performance, Higher raw score = worse performance") +
  theme_classic()

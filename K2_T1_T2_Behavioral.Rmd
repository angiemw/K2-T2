...
library(DT)         # for displaying tables in rendered html
...
ggarrange(p_cc_3, p_cc_4, common.legend = TRUE, legend = "bottom")
...
# arrange plots side by side
ggarrange(p_cc_1, p_cc_2, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_cl_3, p_cl_4, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_cl_1, p_cl_2, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_ce_1, p_ce_2, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_swe_3, p_swe_4, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_swe_1, p_swe_2, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_pde_3, p_pde_4, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_pde_1, p_pde_2, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_wj_3, p_wj_4, common.legend = TRUE, legend = "bottom")
...
# arrange side by side
ggarrange(p_wj_1, p_wj_2, common.legend = TRUE, legend = "bottom")
